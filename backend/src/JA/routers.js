...
router.post('/12th_Stateboard_mark',controller.add_12th_Stateboard_mark);
router.post('/12th_icse_cbsc_mark',controller.add_12th_icse_cbsc_mark);
router.post('/12th_vocational_mark',controller.add_12th_vocational_mark);
